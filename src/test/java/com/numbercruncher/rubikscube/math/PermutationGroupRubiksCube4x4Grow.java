...
class PermutationGroupRubiksCube4x4Grow {
    ...
    void setUp() {
        ...
        String[] selectedLabels = {"T","F","D","L","R","B"};
        Permutation[] selectedGenerators = {t,f,d,l,r,b};

        rubiksGroup = new PermutationGroup("Rubik's Cube Group",selectedLabels,selectedGenerators);
